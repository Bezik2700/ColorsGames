...
fun LevelSix(navController: NavController) {
            ...
            Dialog(onDismissRequest = { showMyDialog1.value = false }) {
                Card (modifier = Modifier
                    ...
                    Column(modifier = Modifier
                        .fillMaxSize()
                        .padding(16.dp)){
                        Text(text = stringResource(R.string.textDescription6))
    ...
    Column (
        ...
        Row {
            Text(
                stringResource(id = R.string.times,"$sec"),
                fontSize = 24.sp,
                style = MaterialTheme.typography.bodyMedium,
                color = Color.Blue
            )
